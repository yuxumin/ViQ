...
class LFQ(Module):
    def __init__(
        ...
        *,
        ...
        output_feat_dim = default(output_feat_dim, dim)
        self.project_out = nn.Linear(codebook_dims, output_feat_dim, bias = projection_has_bias) if has_projections else nn.Identity()
        self.has_projections = has_projections

        print(f"Quantizer Info: input dim {dim}, codebook_dim {codebook_dims}, output dim {output_feat_dim}")
    ...
    def forward(
        ...
        return x, aux_loss, {"H": codebook_entropy, "indices": indices, "avg_prob": avg_prob}
