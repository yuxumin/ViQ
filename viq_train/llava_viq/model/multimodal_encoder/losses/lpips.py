...
class LPIPS(nn.Module):
    ...
    def load_pretrained(self, name="vgg_lpips"):
        ckpt = get_ckpt_path(name, os.environ.get("LPIPS_CKPT_DIR", "pretrained/lpips"))
        self.load_state_dict(torch.load(ckpt, map_location=torch.device("cpu")), strict=False)
        print("[LPIPS] loaded pretrained LPIPS loss from {}".format(ckpt))
